...
int64_t sizeReads = 0;
int64_t numWrites = 0;
int64_t sizeWrites = 0;
int64_t numStrands = 0;
int64_t numIntervals = 0;
int64_t intervalSize = 0;
int64_t numIntervalsRead = 0;
int64_t numIntervalsWrite = 0;
int64_t intervalSizeRead = 0;
int64_t intervalSizeWrite = 0;
